...
public:
	...
	HRESULT		Print(float x, float y, DWORD color, const std::string strText, bool isShadow = false);
	HRESULT		PrintShadow(float x, float y, DWORD color, const std::string strText);
...
public:
	...
	void	D3DCircle(int x, int y, int radius, D3DCOLOR colour, bool filled = false);
	void	D3DGradient(int x, int y, int w, int h, D3DCOLOR fcolor, D3DCOLOR lcolor);
