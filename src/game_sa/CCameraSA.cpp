...
#define FUNC_CollisionDetection				0x520190

#define CALL_CollisionDetection				0x5208A7
#define CALL_CollisionDetection_1			0x520D9E
#define CALL_CollisionDetection_2			0x52102D
#define CALL_CollisionDetection_3			0x522A72
#define CALL_CollisionDetection_4			0x5244C9
#define CALL_CollisionDetection_5			0x525D98
...
void __stdcall CollisionDetectionProc(DWORD bodyOffset, int a2);
...
CCameraSA::CCameraSA(CCameraSAInterface * cameraInterface)
{
	...
	HookInstallCall(CALL_CollisionDetection, (DWORD)CollisionDetectionProc);
	HookInstallCall(CALL_CollisionDetection_1, (DWORD)CollisionDetectionProc);
	HookInstallCall(CALL_CollisionDetection_2, (DWORD)CollisionDetectionProc);
	HookInstallCall(CALL_CollisionDetection_3, (DWORD)CollisionDetectionProc);
	HookInstallCall(CALL_CollisionDetection_4, (DWORD)CollisionDetectionProc);
	HookInstallCall(CALL_CollisionDetection_5, (DWORD)CollisionDetectionProc);
}
...
VOID CCameraSA::Restore()
{
	...
	((void(__thiscall *)(void *))(FUNC_Restore))(cameraInterface);
...
VOID CCameraSA::RestoreWithJumpCut()
{
	...
	((void(__thiscall *)(void *))(0x50BD40))(cameraInterface);
	((void(__thiscall *)(void *))(0x50BAB0))(cameraInterface);
...
VOID CCameraSA::TakeControl(CEntity * entity, eCamMode CamMode, int CamSwitchStyle)
{
	...
	((void(__thiscall *)(void *, void *, int, int, int))(FUNC_TakeControl))(cameraInterface, entityInterface, CamMode, CamSwitchStyle, 1);
...
VOID CCameraSA::TakeControl(CVector * position, int CamSwitchStyle)
{
	...
	Log("VOID CCameraSA::TakeControlNoEntity(CVector * position, int CamSwitchStyle)");
	...
	((void(__thiscall *)(void *, void *, int, int))(FUNC_TakeControlNoEntity))(cameraInterface, position, CamSwitchStyle, 1);
	((void(__thiscall *)(void *, void *, void *))(0x50BEC0))(cameraInterface, position, &vecOffset);
...
VOID CCameraSA::SetMatrix(CMatrix * matrix, bool setPosition)
{
...
void CCameraSA::SetCameraRotation(float rotation)
{
	*(float *)VAR_CameraRotation = rotation;
}
...
void __stdcall CollisionDetectionProc(DWORD bodyOffset, int a2)
{
	...
	else *(char*)VAR_CameraClipStaticObjects = 1;

	if (!bCameraClipVehicles)
		*(char*)VAR_CameraClipVehicles = 0;

	return ((void(__stdcall *)(DWORD, DWORD))(FUNC_CollisionDetection))(bodyOffset, a2);
