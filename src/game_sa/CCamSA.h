...
public:
	...
	void                SetFOVSpeed					( float fFOVSpeed )  { m_pInterface->FOVSpeed = fFOVSpeed; }	
	float               GetAlpha					() const        { return m_pInterface->Alpha; }
	void                SetAlpha					(float Alpha)  { m_pInterface->Alpha = Alpha; }
	void                SetAlphaSpeed				(float fAlphaSpeed)  { m_pInterface->AlphaSpeed = fAlphaSpeed; }
	float               GetBeta						() const        { return m_pInterface->Beta; }
	void                SetBeta						(float Beta)  { m_pInterface->Beta = Beta; }
	void                SetBetaSpeed				(float fBetaSpeed)  { m_pInterface->BetaSpeed = fBetaSpeed; }
