...
DWORD CVehicleSA::GetBaseVehicleType(void)
{
	...
	return ((DWORD(__thiscall *)(void *))FUNC_CVehicle_GetBaseVehicleType)(m_pInterface);
...
float CVehicleSA::GetHeightAboveRoad(void)
{
	...
	return ((float(__thiscall *)(void *))FUNC_CVehicle_GetHeightAboveRoad)(GetVehicleInterface());
...
bool CVehicleSA::GetTowBarPos(CVector* pVector)
{
	...
	return ((bool(__thiscall *)(void *, CVector *, bool, CVehicleSA *))vehicleVTBL->GetTowbarPos)(m_pInterface, pVector, true, NULL);
...
bool CVehicleSA::GetTowHitchPos(CVector* pVector)
{
	...
	return ((bool(__thiscall *)(void *, CVector *, bool, CVehicleSA *))vehicleVTBL->GetTowHitchPos)(m_pInterface, pVector, true, NULL);
...
bool CVehicleSA::SetTowLink(CVehicle* pVehicle)
{
	...
	if (pVehicleSA)
	{
		...
		return ((bool(__thiscall*)(void *, void *, bool))(vehicleVTBL->SetTowLink))(this->GetInterface(), pVehicleInt, true);
