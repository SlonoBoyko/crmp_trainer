...
CVehicle * CPedSA::GetVehicle()
{
	...
	if (((CPedSAInterface *)this->GetInterface())->pedFlags.bInVehicle)
	{
		...
		if (vehicle) return ((CPoolsSA *)pGame->GetPools())->GetVehicle((DWORD *)vehicle);
	}
	return NULL;
}
...
CVector * CPedSA::GetBonePosition(eBone bone, CVector * vecPosition)
{
	...
	((void(__thiscall *) (void *, CVector *, int32_t, bool))FUNC_GetBonePosition) (this->GetInterface(), vecPosition, bone, true);


	return vecPosition;
}

CVector * CPedSA::GetTransBonePos(eBone bone, CVector * vecPosition)
{
	/*DWORD dwFunc = FUNC_GetTransBonePosition;
	DWORD dwThis = (DWORD)this->GetInterface();
	_asm
	{
		push    1
	...
	((void(__thiscall *) (void *, CVector *, uint32_t, bool))FUNC_GetTransBonePosition) (this->GetInterface(), vecPosition, bone, true);
