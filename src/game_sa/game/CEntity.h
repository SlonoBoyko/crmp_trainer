...
public:
	...
	virtual CVector						* GetRoll( CVector *vecRoll ) =0;
    virtual void                        SetDirection ( CVector *vecDir ) =0;
	virtual CVector						* GetDirection( CVector *vecDir ) =0;
    virtual void                        SetWas ( CVector *vecWas ) =0;
	virtual CVector						* GetWas( CVector *vecWas ) =0;
	...
	virtual void						SetIsLocked( bool bLocking ) = 0;
